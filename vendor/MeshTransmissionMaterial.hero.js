// Vanilla port of drei MeshTransmissionMaterial (chromatic-aberration glass) for three-hero.
...
// tiny discard material so the glass mesh is invisible in the refraction buffer pass
class DiscardMaterial extends THREE.ShaderMaterial {
  constructor(){ super({vertexShader:'void main(){}', fragmentShader:'void main(){ gl_FragColor=vec4(0.0); discard; }'}); }
}

export { MeshTransmissionMaterialImpl, DiscardMaterial };
